...
# CLI Install
Installing UICelerate with the CLI
...
You can install UICelerate components through the CLI. Use the following command structure:

```
npx shadcn@latest add https://uicelerate.com/registry/[component].json
```

Adds a new component to your project.

```
npx shadcn@latest add https://uicelerate.com/registry/chat-bubble.json
```
